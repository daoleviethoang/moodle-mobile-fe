...
class ShortAnswerDoQuiz extends StatefulWidget {
  final int uniqueId;
  final int slot;
  final String html;
  final String token;
  ...
  @override
  State<ShortAnswerDoQuiz> createState() => _ShortAnswerDoQuizState();
}

class _ShortAnswerDoQuizState extends State<ShortAnswerDoQuiz> {
  dom.Element? answer;
  String question = "";
  List<String> keySave = ["", ""];
  ...
  parseHtml() {
    ...
    if (input != null && input!.attributes['value'] != null && input!.attributes['value'] != "") {
...
class ShortAnswerDoTile extends StatelessWidget {
  final dom.Element element;
  final _ShortAnswerDoQuizState state;
  final TextEditingController controller;
  const ShortAnswerDoTile({
    Key? key,
